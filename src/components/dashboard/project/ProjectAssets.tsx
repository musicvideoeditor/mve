import { Box, Button, Checkbox, HStack, Input, InputGroup, InputLeftElement, Stack, Table, TableContainer, Tbody, Text, Th, Thead, Tr, VStack } from '@chakra-ui/react';
...
const ProjectAssets = ({ onSubmit }: { onSubmit: () => void }) => {
    return (
      <>
        <Stack direction={["column", "row"]} alignItems={'flex-start'} gap={4} mb={8}>
